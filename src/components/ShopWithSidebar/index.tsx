  ...
  return (
    <>
      <Breadcrumb
        ...
        pages={["shop",]}
      />
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-light-5/50 via-gray-1 to-gray-1 pb-16 pt-8 lg:pb-20 lg:pt-12">
        <div className="relative z-1 mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          ...
          <div className="relative mb-8">
            <span className="mb-2 inline-flex items-center gap-2 rounded-full border border-blue-light-4 bg-blue-light-5 px-2.5 py-1 text-custom-xs font-semibold text-blue-dark">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-blue" aria-hidden>
                <path
          ...
          <div className="flex gap-6 lg:gap-7.5">
            ...
            <div
              className={`sidebar-content fixed left-0 top-0 z-9999 w-full max-w-[310px] ease-out duration-200 xl:static xl:z-1 xl:max-w-[270px] xl:translate-x-0 ${productSidebar
                ? "h-screen translate-x-0 overflow-y-auto bg-white p-5 shadow-xl xl:bg-transparent xl:p-0 xl:shadow-none"
                : "-translate-x-full"
                }`}
            >
              <button
                ...
                className={`absolute -right-12.5 flex h-9 w-9 items-center justify-center rounded-xl border border-blue-light-4 bg-white text-blue shadow-brand-sm xl:hidden sm:-right-8 ${stickyMenu
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                  {/* <!-- filter box --> */}
                  <div className="rounded-2xl border border-blue-light-4/60 bg-white px-5 py-4 shadow-[0_8px_30px_-12px_rgba(147,51,234,0.08)]">
                    <div className="flex items-center justify-between">
                      <p className="font-bold text-dark">Filters</p>
                      <button
                        type="button"
                        onClick={handleClearFilters}
                        className="text-custom-sm font-semibold text-blue transition-colors hover:text-blue-dark"
                      >
                        Clear all
                      </button>
                    </div>
            ...
            <div className="xl:max-w-[870px] w-full">
              <div className="mb-6 rounded-2xl border border-blue-light-4/60 bg-white py-3 pl-3 pr-2.5 shadow-[0_8px_30px_-12px_rgba(147,51,234,0.08)]">
                <div className="flex items-center justify-between">
                  {/* <!-- top bar left --> */}
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p className="text-custom-sm text-dark-4">
                      ...
                      of <span className="font-medium text-dark">{filteredProducts.length}</span> products
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${productStyle === "grid"
                        ...
                        } flex h-9 w-10.5 items-center justify-center rounded-xl border ease-out duration-200 hover:border-blue hover:bg-blue hover:text-white`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
              ...
              {totalPages > 1 && (
                <div className="mt-12 flex justify-center">
                  <div className="rounded-2xl border border-blue-light-4/60 bg-white p-2 shadow-[0_8px_30px_-12px_rgba(147,51,234,0.08)]">
