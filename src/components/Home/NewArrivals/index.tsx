...
const NewArrival = ({ products }: NewArrivalProps) => {
  return (
    <section className="overflow-hidden pt-14 pb-8 sm:pt-15 sm:pb-10">
        ...
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4 sm:mb-10">
          <div>
            ...
            <p className="mt-2 max-w-md text-custom-sm text-dark-4">
              Fresh picks added to our catalog — explore the latest products.
            </p>
          </div>
